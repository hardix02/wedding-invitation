...
window.WEDDING = {
  ...
  events: [
    ...
    { name: "પીઠી", date: "તા. ૧૧ ડિસેમ્બર ૨૦૨૬, શનિવાર", time: "સાંજે ૯:૦૦ કલાકે", icon: "flower", note: "પીળા વસ્ત્રોમાં પધારવા વિનંતી" },
    ...
    { name: "જાન પ્રસ્થાન", date: "તા. ૧૩ ડિસેમ્બર ૨૦૨૬, રવિવાર", time: "સાંજે ૫:૦૦ કલાકે", icon: "dhol", note: "વરરાજાની જાન" },
    { name: "હસ્તમેળાપ", date: "તા. ૧૩ ડિસેમ્બર ૨૦૨૬, રવિવાર", time: "બપોરે ૧૨:૦૦ કલાકે", icon: "rings", note: "લગ્નવિધિ, સપ્તપદી અને આશીર્વાદ" },
    { name: "સ્વાગત સમારંભ", date: "તા. ૧૪ ડિસેમ્બર ૨૦૨૬, સોમવાર", time: "સાંજે ૬:૦૦ કલાકે", icon: "kalash", note: "નવદંપતીને આશીર્વાદ આપવા પધારશો" }
  ],
